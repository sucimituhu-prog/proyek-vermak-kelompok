...
export default function Dashboard() {
  ...
  // 5 pesanan terbaru berdasarkan ID — semua status
      ...
      <section className="panel-grid">
        <div className="panel">
          <div className="panel__header">
            <div>
              <p className="panel__eyebrow">Ringkasan Pesanan</p>
              <h3 className="panel__title">5 Pesanan Terbaru</h3>
            </div>
          </div>
            ...
            {STATUS_URUTAN.map((s) => {
              ...
              return (
                <div key={s} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <span style={{ display: 'inline-block', width: '10px', height: '10px', borderRadius: '50%', backgroundColor: cfg.border, flexShrink: 0 }} />
